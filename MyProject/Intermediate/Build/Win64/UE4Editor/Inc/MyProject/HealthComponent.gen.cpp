...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//  Controller of the pawn that caused damage\n// Projectile\n" },
		{ "ModuleRelativePath", "HealthComponent.h" },
		{ "ToolTip", "Controller of the pawn that caused damage\nProjectile" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_DamageTaken, "DamageTaken" }, // 494316520
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHealthComponent, 2988817187);
